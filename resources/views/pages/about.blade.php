    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4 stagger-parent">
            ...
            <div class="group text-center stagger-child animate-on-scroll opacity-0 translate-y-10">
                ...
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-1">Jean Dupont</h3>
                <p class="text-sky-600 dark:text-sky-400 font-semibold mb-2">CEO & Fondateur</p>
                <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Expert en transformation digitale avec 15+ ans d'expérience</p>
                <!-- Social links -->
            ...
            <div class="group text-center stagger-child animate-on-scroll opacity-0 translate-y-10">
                ...
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-1">Marie Martin</h3>
                <p class="text-cyan-600 dark:text-cyan-400 font-semibold mb-2">CTO</p>
                <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Architecte logiciel senior spécialisée en cloud</p>
                <div class="flex justify-center gap-3">
            ...
            <div class="group text-center stagger-child animate-on-scroll opacity-0 translate-y-10">
                ...
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-1">Pierre Durand</h3>
                <p class="text-blue-600 dark:text-blue-400 font-semibold mb-2">Lead Developer</p>
                <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Full-stack expert passionné par le code propre</p>
                <div class="flex justify-center gap-3">
            ...
            <div class="group text-center stagger-child animate-on-scroll opacity-0 translate-y-10">
                ...
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-1">Sophie Bernard</h3>
                <p class="text-indigo-600 dark:text-indigo-400 font-semibold mb-2">UX/UI Designer</p>
                <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Spécialiste design thinking et expérience utilisateur</p>
                <div class="flex justify-center gap-3">
                    <a href="#" class="h-8 w-8 flex items-center justify-center rounded-lg bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-400 hover:bg-indigo-500 hover:text-white transition-colors">
                        <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M6.29 18.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0020 3.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.073 4.073 0 01.8 7.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 010 16.407a11.616 11.616 0 006.29 1.84"/>
                        </svg>
                    </a>
