...
<div class="bg-gradient-to-b from-gray-900 via-gray-900 to-white dark:to-gray-900 relative isolate overflow-hidden">
    ...
    <div aria-hidden="true" class="absolute inset-0 -z-10">
        <div class="absolute inset-x-0 top-0 h-full bg-gradient-to-b from-{{ $service->color }}-500/10 via-transparent to-transparent"></div>
    ...
    <div class="relative px-6 pt-8 lg:px-8">
        <div class="mx-auto max-w-4xl py-16 sm:py-20 lg:py-24">
            ...
            <nav class="flex items-center justify-center gap-x-2 text-sm mb-8">
                <a href="{{ route('services') }}" class="text-gray-400 hover:text-sky-400 transition-colors duration-300 flex items-center gap-1">
            ...
            <div class="text-center">
                ...
                <div class="flex justify-center mb-8">
                    <div class="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-sky-400 to-cyan-400 shadow-2xl ring-4 ring-white/20">
                        @if($service->icon)
                            {!! $service->icon !!}
                        @else
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="prose prose-lg prose-gray dark:prose-invert max-w-none text-gray-900 dark:text-gray-100">
                ...
                <div class="mt-12">
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
                        <div class="w-1 h-8 bg-gradient-to-b from-sky-500 to-cyan-500 rounded-full"></div>
                        Caractéristiques principales
                    </h2>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        @foreach($service->features as $feature)
                        <div class="flex items-start gap-3 p-4 rounded-xl bg-gray-50 dark:bg-gray-800/50 ring-1 ring-gray-200 dark:ring-gray-700 hover:ring-sky-500/50 transition-all duration-300">
                ...
                <div class="mt-16">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="relative p-6 rounded-2xl bg-gradient-to-br from-sky-50 to-cyan-50 dark:from-gray-800 dark:to-gray-800/50 ring-1 ring-gray-200 dark:ring-gray-700">
                            <div class="absolute -top-4 -left-4 w-12 h-12 rounded-xl bg-gradient-to-br from-sky-500 to-cyan-500 flex items-center justify-center text-white font-bold text-xl shadow-lg">1</div>
                        ...
                        <div class="relative p-6 rounded-2xl bg-gradient-to-br from-sky-50 to-cyan-50 dark:from-gray-800 dark:to-gray-800/50 ring-1 ring-gray-200 dark:ring-gray-700">
                            <div class="absolute -top-4 -left-4 w-12 h-12 rounded-xl bg-gradient-to-br from-sky-500 to-cyan-500 flex items-center justify-center text-white font-bold text-xl shadow-lg">2</div>
                        ...
                        <div class="relative p-6 rounded-2xl bg-gradient-to-br from-sky-50 to-cyan-50 dark:from-gray-800 dark:to-gray-800/50 ring-1 ring-gray-200 dark:ring-gray-700">
                            <div class="absolute -top-4 -left-4 w-12 h-12 rounded-xl bg-gradient-to-br from-sky-500 to-cyan-500 flex items-center justify-center text-white font-bold text-xl shadow-lg">3</div>
                        ...
                        <div class="relative p-6 rounded-2xl bg-gradient-to-br from-sky-50 to-cyan-50 dark:from-gray-800 dark:to-gray-800/50 ring-1 ring-gray-200 dark:ring-gray-700">
                            <div class="absolute -top-4 -left-4 w-12 h-12 rounded-xl bg-gradient-to-br from-sky-500 to-cyan-500 flex items-center justify-center text-white font-bold text-xl shadow-lg">4</div>
            ...
            <aside class="lg:col-span-1">
                <div class="sticky top-24 space-y-6">
                    ...
                    <div class="rounded-2xl bg-gradient-to-br from-sky-500 to-cyan-500 p-6 text-white shadow-xl">
                        ...
                        <a href="{{ route('contact') }}" class="block w-full text-center bg-white text-sky-600 font-semibold py-3 px-4 rounded-lg hover:bg-sky-50 transition-colors duration-300 shadow-lg mb-3">
                            Demander un devis
                        </a>
                        <div class="flex items-center gap-3 text-sm text-sky-100">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            @foreach($relatedServices as $related)
                <a href="{{ route('services.show', $related) }}" class="group flex flex-col p-8 rounded-2xl bg-white dark:bg-gray-900 shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-gray-200 dark:ring-gray-700 hover:ring-sky-500/50 hover:-translate-y-1">
                    <div class="flex items-center justify-center w-16 h-16 rounded-xl bg-gradient-to-br from-sky-400 to-cyan-400 mb-6 group-hover:scale-110 transition-transform duration-300">
                        @if($related->icon)
                            {!! $related->icon !!}
                        @else
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3 group-hover:text-sky-600 dark:group-hover:text-sky-400 transition-colors">
                        {{ $related->title }}
                    </h3>
                    <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed flex-1">
                        {{ Str::limit($related->description, 120) }}
                    </p>
                    <div class="mt-6 flex items-center text-sky-600 dark:text-sky-400 font-semibold text-sm group-hover:gap-2 transition-all duration-300">
                        En savoir plus
...
<div class="bg-gradient-to-br from-gray-900 via-sky-900 to-gray-900 relative overflow-hidden">
    ...
    <div class="relative px-6 py-20 sm:px-6 sm:py-24 lg:px-8">
        <div class="mx-auto max-w-3xl text-center">
            ...
            <p class="text-xl leading-8 text-gray-300 mb-10">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <a href="{{ route('services') }}" class="inline-flex items-center gap-2 text-base font-semibold text-white hover:text-gray-300 transition-colors duration-300 px-6 py-3">
                    Tous nos services
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/>
                    </svg>
