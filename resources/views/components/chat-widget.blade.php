        ...
        if (this.newMessage.trim()) {
            ...
            setTimeout(() => {
                ...
                if (userMsg.includes('prix') || userMsg.includes('tarif') || userMsg.includes('coût')) {
                    ...
                    botResponse = 'Nous proposons des services de développement web, applications mobiles, cloud et cybersécurité. Consultez notre page Services pour en savoir plus ! 🚀';
