        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div class="col-span-1 md:col-span-2 lg:col-span-1">
                ...
                <div class="flex space-x-4 mt-6">
                    ...
                    <a href="https://www.instagram.com/genesis_entreprises_rdc?igsh=MW5hNmcwaHFkYzdnOQ%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-pink-600 dark:hover:text-pink-400 transition-colors duration-300">
                    ...
                    <a href="https://www.linkedin.com/in/genesis-entreprise-70915437a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-genesis-blue-500 dark:hover:text-genesis-blue-400 transition-colors duration-300">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li>
                        <a href="{{ route('services') }}" class="text-gray-600 dark:text-gray-400 hover:text-sky-500 dark:hover:text-sky-400 text-base transition-colors duration-300 flex items-center group">
                            <svg class="w-4 h-4 mr-2 opacity-0 -ml-6 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                            </svg>
                            Services
                    ...
                    <li>
                        <a href="{{ route('about') }}" class="text-gray-600 dark:text-gray-400 hover:text-sky-500 dark:hover:text-sky-400 text-base transition-colors duration-300 flex items-center group">
                            <svg class="w-4 h-4 mr-2 opacity-0 -ml-6 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                            </svg>
                            À propos
                    ...
                    <li>
                        <a href="{{ route('projects') }}" class="text-gray-600 dark:text-gray-400 hover:text-sky-500 dark:hover:text-sky-400 text-base transition-colors duration-300 flex items-center group">
                            <svg class="w-4 h-4 mr-2 opacity-0 -ml-6 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                            </svg>
                            Projets
                    ...
                    <li>
                        <a href="{{ route('blog.index') }}" class="text-gray-600 dark:text-gray-400 hover:text-sky-500 dark:hover:text-sky-400 text-base transition-colors duration-300 flex items-center group">
                            <svg class="w-4 h-4 mr-2 opacity-0 -ml-6 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                            </svg>
                            Blog
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li class="text-gray-600 dark:text-gray-400 text-base flex items-center">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li>
                        <a href="{{ route('brochure.download') }}" class="inline-flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-genesis-purple-600 dark:hover:text-genesis-purple-400 text-base transition-colors duration-300 group">
                            <svg class="w-5 h-5 text-genesis-purple-500/50 group-hover:text-genesis-purple-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                            </svg>
                            Télécharger la brochure
                        </a>
                    </li>
                    <li class="flex items-center gap-2 text-gray-600 dark:text-gray-400 text-base">
                        <svg class="w-5 h-5 text-sky-500/50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                        </svg>
                        infos@genesisentreprise.com
                    </li>
                    <li class="flex items-center gap-2 text-gray-600 dark:text-gray-400 text-base">
                        <svg class="w-5 h-5 text-sky-500/50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
